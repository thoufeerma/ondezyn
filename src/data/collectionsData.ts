...
export const collectionsData: Record<string, CollectionData> = {
  "signature-designs": {
    ...
    heroImage: "https://images.unsplash.com/photo-1599452388339-039c3629475e?q=80&w=2000",
    ...
    items: [
      { name: "Signature Styles", image: "https://images.unsplash.com/photo-1595919644098-fb0100c5031b?q=80&w=1200", description: "Exclusive silhouettes defined by the ONDEZYN aesthetic." },
      { name: "Hand crafted Uniques", image: "https://images.unsplash.com/photo-1610030469983-98e550d6193c?q=80&w=1200", description: "One-of-a-kind pieces featuring intricate hand-done details." },
      { name: "Designer Blouse", image: "https://images.unsplash.com/photo-1617627143750-d86bc21e42bb?q=80&w=1200", description: "Artistically constructed blouses for the modern visionary." },
      { name: "Designer Salwar sets", image: "https://images.unsplash.com/photo-1631558556857-e6308008447d?q=80&w=1200", description: "Elegant salwar sets with a contemporary luxury twist." },
      { name: "Mom & Daughter Combo", image: "https://images.unsplash.com/photo-1618331835717-801e976710b2?q=80&w=1200", description: "Synchronized elegance for the most precious connections." }
    ]
  },
  "ethnic-wears": {
    id: "ethnic-wears",
    title: "Ethnic Wears",
    heroImage: "https://images.unsplash.com/photo-1583391733956-6c78276477e2?q=80&w=2000",
    ...
    items: [
      { name: "Lehanga", image: "https://images.unsplash.com/photo-1595919644098-fb0100c5031b?q=80&w=1200", description: "Grand voluminous lehengas for celebrations and festivals." },
      { name: "Anarkali Dresses", image: "https://images.unsplash.com/photo-1599452388339-039c3629475e?q=80&w=1200", description: "Flowing grace with intricate embroidery and rich fabrics." },
      { name: "Saree Styling", image: "https://images.unsplash.com/photo-1583391733956-6c78276477e2?q=80&w=1200", description: "The art of the drape, redefined for modern elegance." },
      { name: "Sharara sets", image: "https://images.unsplash.com/photo-1621430005523-6428c04ec47d?q=80&w=1200", description: "Vibrant and festive sharara sets with detailed work." },
      { name: "Kurtis", image: "https://images.unsplash.com/photo-1631558556857-e6308008447d?q=80&w=1200", description: "Sophisticated daily luxury and occasion-ready kurtis." }
    ]
  },
  "party-wears": {
    id: "party-wears",
    title: "Party Wears",
    heroImage: "https://images.unsplash.com/photo-1566174053879-31528523f8ae?q=80&w=2000",
    ...
    items: [
      { name: "Indo Western Dresses", image: "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?q=80&w=1200", description: "The perfect fusion of global silhouettes and Indian artistry." },
      { name: "Designer Gowns", image: "https://images.unsplash.com/photo-1566174053879-31528523f8ae?q=80&w=1200", description: "Ethereal gowns that bring a touch of cinematic glamour." },
      { name: "Crop top & Skirt sets", image: "https://images.unsplash.com/photo-1619785294559-869ac7f23df0?q=80&w=1200", description: "Chic, modern coordinates for the stylish celebrant." },
  ...
  "bridal-wears": {
    id: "bridal-wears",
    title: "Bridal Wears",
    heroImage: "https://images.unsplash.com/photo-1594463750939-ebb28c3f7f75?q=80&w=2000",
  ...
  "accessories": {
    id: "accessories",
    title: "Accessories",
    heroImage: "https://images.unsplash.com/photo-1610030469983-98e550d6193c?q=80&w=2000",
  ...
  "kids-specials": {
    id: "kids-specials",
    title: "Kids Specials",
    heroImage: "https://images.unsplash.com/photo-1618331835717-801e976710b2?q=80&w=2000",
