...
export default function Home() {
  ...
  return (
    <>
      ...
      {loading && (
        <div 
          className="fixed inset-0 bg-white/40 backdrop-blur-xl z-[10000] flex flex-col justify-center items-center transition-all duration-1000 ease-in-out" 
        ...
        >
          ...
          <div className="w-[250px] h-[2px] bg-black/10 overflow-hidden">
