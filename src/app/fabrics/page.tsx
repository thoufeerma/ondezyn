        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="reveal">
            ...
            <div className="grid grid-cols-2 gap-6 mb-12">
              {/* Pure Silk Card */}
              <div
                className="aspect-[4/5] bg-white/5 rounded-2xl border border-white/10 flex flex-col items-center justify-center gap-4 group overflow-hidden relative shadow-2xl cursor-pointer"
                onClick={() => openLightbox("/images/fabrics/pure-silk.png", "Pure Silk Saree")}
                role="button"
                tabIndex={0}
                onKeyDown={(e) => e.key === "Enter" && openLightbox("/images/fabrics/pure-silk.png", "Pure Silk Saree")}
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/60 group-hover:bg-black/35 transition-all duration-500"></div>
              ...
              <div
                className="aspect-[4/5] bg-white/5 rounded-2xl border border-white/10 flex flex-col items-center justify-center gap-4 group overflow-hidden relative shadow-2xl cursor-pointer"
                onClick={() => openLightbox("/images/fabrics/kasavu.png", "Kasavu Saree")}
                role="button"
                tabIndex={0}
                onKeyDown={(e) => e.key === "Enter" && openLightbox("/images/fabrics/kasavu.png", "Kasavu Saree")}
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center gap-2">
                  <Package className="text-accent-gold" size={32} />
                  <span className="text-[0.6rem] tracking-[0.3em] uppercase text-white/80 font-bold">Kasavu</span>
                </div>
              </div>
            </div>
